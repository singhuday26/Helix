...
const Footer = () => {
  ...
  const footerLinks = {
    Product: [
      ...
      { name: "Comparison Demo", href: "/comparison" },
    ...
    Resources: [
      ...
      {
        name: "GitHub",
        href: "https://github.com/singhuday26/Helix",
        external: true,
      },
      {
        name: "Research Paper",
    ...
    Technology: [
      { name: "Speculative Decoding", href: "/#technology" },
      { name: "PagedAttention", href: "/#technology" },
      { name: "DirectML Integration", href: "/#features" },
    ],
  };

  return (
    <footer className="bg-void-950 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Fast LLM inference through speculative decoding. Built for edge
              devices, optimized for production.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-600">
            © {currentYear} Helix. Open source under MIT License.
          </p>
